							...
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src={{asset("Home/images/01_small.jpg")}} mid={{asset("Home/images/01_mid.jpg")}} big={{asset("Home/images/01.jpg")}}></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src={{asset("Home/images/02_small.jpg")}} mid={{asset("Home/images/02_mid.jpg")}} big={{asset("Home/images/02.jpg")}}></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src={{asset("Home/images/03_small.jpg")}} mid={{asset("Home/images/03_mid.jpg")}} big={{asset("Home/images/03.jpg")}}></a>
									</div>
								</li>
							</ul>
						</div>
