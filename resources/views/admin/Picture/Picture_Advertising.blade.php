   ...
   <div class="border clearfix">
	...
	<tbody>
      <tr>
       ...
       <td>幻灯片</td>
       <td><span class="ad_img"><img src={{asset("admin/products/ad.jpg")}}  width="100%" height="100%"/></span></td>
       <td>1890x1080</td>
...
<div id="add_ads_style"  style="display:none">
 ...
 <div class="demo">
	           <div class="logobox"><div class="resizebox"><img src={{asset("/admin/images/image.png")}} width="100px" alt="" height="100px"/></div></div>	
