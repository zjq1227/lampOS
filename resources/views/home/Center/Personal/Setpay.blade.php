		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="tel" id="user-password" name="zpwd" placeholder="6位数字">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label" >确认密码</label>
							<div class="am-form-content">
								<input type="tel" id="user-confirm-password" name="rezpwd" placeholder="请再次输入上面的密码">
							</div>
						</div>
						<div class="info-btn">
				...
				<script>
										...
										//发送验证码
										$.post('{{route("Setpay.sendPhone")}}',{'_token':'{{csrf_token()}}','phone':$('#user-phone').text()},function(res){
											console.log(res);
											if(res.error_code == 0){
												alert('发送成功，验证码十分钟有效');
											}else{
