...
<!---->
 <iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO  SRC="{{route('Category_add','empty')}}" class="page_right_style"></iframe>
 </div>
</div>
</body>
</html>
...
var setting = {
	...
	},function(data) //第二个参数要传token的值 再传参数要用逗号隔开
	{
		...
		$('a[class=level0]').click(function(){
			var name=$(this).text();
			demoIframe.attr("src",'../../admin/Product/Category_add'+'/'+name);
		});
	});
