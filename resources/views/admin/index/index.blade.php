...
<html lang="en">
	<head>
		...
		<link href="/admin-style/assets/css/bootstrap.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="/admin-style/assets/css/font-awesome.min.css" />
		<!--[if IE 7]>
		  <link rel="stylesheet" href="/admin-style/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="/admin-style/assets/css/ace.min.css" />
		<link rel="stylesheet" href="/admin-style/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="/admin-style/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="/admin-style/css/style.css"/>
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="/admin-style/assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="/admin-style/assets/js/ace-extra.min.js"></script>
		<!--[if lt IE 9]>
		<script src="/admin-style/assets/js/html5shiv.js"></script>
		<script src="/admin-style/assets/js/respond.min.js"></script>
		<![endif]-->
        <!--[if !IE]> -->
		<script src="/admin-style/js/jquery-1.9.1.min.js"></script>        
		<!-- <![endif]-->
		<!--[if IE]>
		...
		<script src="/admin-style/assets/js/bootstrap.min.js"></script>
		<script src="/admin-style/assets/js/typeahead-bs2.min.js"></script>
		<!--[if lte IE 8]>
		  <script src="/admin-style/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="/admin-style/assets/js/ace-elements.min.js"></script>
		<script src="/admin-style/assets/js/ace.min.js"></script>
        <script src="/admin-style/assets/layer/layer.js" type="text/javascript"></script>
		<script src="/admin-style/assets/laydate/laydate.js" type="text/javascript"></script>
        <script src="/admin-style/js/jquery.nicescroll.js" type="text/javascript"></script>
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="https://item.taobao.com/item.htm?id=539837098284" class="navbar-brand">
						<small>					
						<img src="/admin-style/images/logo.png" width="470px">
						</small>
					</a><!-- /.brand -->
				</div><!-- /.navbar-header -->
