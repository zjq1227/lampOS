  ...
  <div class="sort_list">
	...
	<tbody>
      ...
      <td class="td-manage">
        ...
        <a title="编辑" href="{{route('Picture_Sortads_Upload')}}"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
        <a title="删除" href="javascript:;"  onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
        <a href="javascript:ovid()" name="{{route('Picture_Ads_List')}}" class="btn btn-xs btn-pink ads_link" onclick="AdlistOrders('561');" title="幻灯片广告列表"><i class="fa  fa-bars  bigger-120"></i></a>
       </td>
      </tr>
    </tbody>
    </table>
...
function AdlistOrders(id){
	window.location.href = "{{route('Picture_Ads_List')}}";
};
</script>
<script type="text/javascript">
jQuery(function($) {
