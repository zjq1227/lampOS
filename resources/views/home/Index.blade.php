			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="{{route('Shopcart')}}" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
					</div>
				...
				<div class="nav white">
					...
					<div class="search-bar pr">
						<a name="index_none_header_sysc" href="{{route('Search')}}"></a>
						<form action="{{route('Search')}}" method="post" enctype="multipart/form-data" id="form-admin-upd">
							{{ csrf_field() }}
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="{{route('Introduction')}}"><img src={{asset("home/images/ad1.jpg")}} /></a></li>
					...
					<div class="am-g am-g-fixed recommendation">
						...
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="{{route('Introduction')}}"><img src={{asset("home/images/tj.png")}}></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
