  ...
  <div class="search_style">
   ...
   <tr>
     ...
     <td class="order_product_name">
      <a href="#" class="product_Display"><img src={{asset("admin/products/p_1.jpg")}}  title="产品名称"/></a>
      <i class="fa fa-plus"></i>
       <a href="#" class="product_Display"><img src={{asset("admin/products/p_2.jpg")}}  title="产品名称"/></a>
     </td>
     <td>456.5</td>
     ...
     <td class="order_product_name">
      ...
      <img src={{asset("admin/products/p_1.jpg")}}  title="产品名称"/>
      </a>
      <i class="fa fa-plus"></i>
       <a href="#" class="product_Display">
       <img src={{asset("admin/products/p_2.jpg")}}  title="产品名称"/>
       </a>
     </td>
     <td>456.5</td>    
     <td>2016-7-5</td>
     ...
     <td>20160705445622</td>
     <td class="order_product_name">
      <a href="#" class="product_Display"><img src={{asset("admin/products/p_1.jpg")}}  title="产品名称"/>
